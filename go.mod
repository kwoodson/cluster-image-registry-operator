...
require (
	...
	github.com/golang/groupcache v0.0.0-20210331224755-41bb18bfe9da // indirect; indirect github.com/golang/protobuf v1.5.2 // indirect github.com/google/gofuzz v1.2.0 // indirect
